    ...
    protected function seedPayrollSettings(): void
    {
        $settings = [
            ...
            [
                ...
                'description' => 'Working days per month used to price a night hour: monthly salary ÷ this ÷ hours in a working day.',
                'type' => 'decimal',
            ...
            [
                ...
                'description' => 'Percentage of the hourly rate paid for each night hour worked. Late minutes come off the night hours. 0.10 is 10%.',
                'type' => 'decimal',
                'group' => 'Night Differential',
            ],
            [
