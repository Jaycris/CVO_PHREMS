...
class StatutorySeeder extends Seeder
{
    ...
    protected function seedPayrollSettings(): void
    {
        $settings = [
            ...
            [
                'key' => 'night_diff_basis',
                'value' => 'per_hour',
                'label' => 'How night differential is paid',
                'description' => 'Only one is ever used. Per hour pays the rate on each hour worked inside the night window, and late minutes come off. Per day pays the rate on a day\'s pay for each night worked, however long it was.',
                'type' => 'choice',
            ...
            [
                ...
                'description' => 'Working days per month used to price night differential. Monthly salary ÷ this is a day\'s pay; ÷ hours in a working day is an hour\'s pay.',
                'type' => 'decimal',
                'group' => 'Night Differential',
            ],
            [
                ...
                'description' => 'Percentage of the hourly rate (per hour) or of a day\'s pay (per day) added for night work. 0.10 is 10%.',
                'type' => 'decimal',
                'group' => 'Night Differential',
            ],
            [
