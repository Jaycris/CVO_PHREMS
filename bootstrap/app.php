...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        // The CRM's employee lookup. Stateless and token-guarded — it must not
        // pick up the web session or CSRF middleware.
    ...
    ->withMiddleware(function (Middleware $middleware): void {
        // Every response, web and API alike. Nothing in a payroll system
        ...
        $middleware->web(append: [
            ...
            // Web only, for the same reason: it has to know who is signed in
            // to let the CEO or COO through. The CRM's API is left running.
