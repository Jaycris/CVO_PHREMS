@php
    $displayName = $slip->employee?->first_name ?: $slip->employeeName() ?: 'Employee';
...
<head>
    ...
    <title>Your CreatiVision HRIS commission slip is ready</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; overflow:hidden; border-radius:18px; background:#ffffff; border:1px solid #dbe3ee;">
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#020617;">
                                <tr>
                                    <td style="padding:34px 38px; background:linear-gradient(135deg,#020617 0%,#0f172a 52%,#052e23 100%);">
                                        ...
                                        <h1 style="margin:0; color:#ffffff; font-size:28px; line-height:1.25; font-weight:800;">Your commission slip is ready</h1>
                                        <p style="margin:12px 0 0; color:#cbd5e1; font-size:15px; line-height:1.7;">Your monthly commission statement is available for review.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:38px;">
                            ...
                            <p style="margin:0; color:#475569; font-size:16px; line-height:1.7;">Your commission slip for {{ $month }} has been prepared and is ready to view securely in your HRIS account.</p>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:24px 0 0; border-radius:14px; background:#f8fafc; border:1px solid #e2e8f0;">
                                <tr>
                                    <td style="padding:18px 20px; border-bottom:1px solid #e2e8f0;">
                                        <p style="margin:0 0 5px; color:#64748b; font-size:11px; font-weight:700; letter-spacing:1.6px; text-transform:uppercase;">Commission month</p>
                                        <p style="margin:0; color:#0f172a; font-size:16px; line-height:1.5; font-weight:700;">{{ $month }}</p>
                                    </td>
                                </tr>
                                @if ($netCommission)
                                <tr>
                                    <td style="padding:18px 20px; border-bottom:1px solid #e2e8f0;">
                                        <p style="margin:0 0 5px; color:#64748b; font-size:11px; font-weight:700; letter-spacing:1.6px; text-transform:uppercase;">Net commission</p>
                                        <p style="margin:0; color:#047857; font-size:20px; line-height:1.5; font-weight:800;">{{ $netCommission }}</p>
                                    </td>
                                </tr>
                                @endif
                                <tr>
                                    <td style="padding:18px 20px;">
                                        <p style="margin:0 0 5px; color:#64748b; font-size:11px; font-weight:700; letter-spacing:1.6px; text-transform:uppercase;">Transactions</p>
                                        <p style="margin:0; color:#0f172a; font-size:16px; line-height:1.5; font-weight:700;">{{ $transactionCount }} {{ \Illuminate\Support\Str::plural('transaction', $transactionCount) }} listed</p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" style="margin:30px 0;">
                                <tr>
                                    <td style="border-radius:12px; background:#157a52;">
                                        <a href="{{ $url }}" style="display:inline-block; padding:14px 24px; color:#ffffff; font-size:15px; font-weight:700; text-decoration:none; border-radius:12px;">View Commission Slip</a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 28px; border-radius:14px; background:#f8fafc; border:1px solid #e2e8f0;">
                                <tr>
                                    <td style="padding:18px 20px;">
                                        <p style="margin:0; color:#334155; font-size:14px; line-height:1.6;"><strong>Review reminder:</strong> Please check your commission slip and tell your team lead within three working days if anything looks incorrect.</p>
                                    </td>
                                </tr>
                            </table>

                            <p style="margin:0; color:#475569; font-size:15px; line-height:1.7;">Regards,<br><strong style="color:#0f172a;">{{ config('app.name') }}</strong></p>
                        </td>
                    </tr>
                    <tr>
