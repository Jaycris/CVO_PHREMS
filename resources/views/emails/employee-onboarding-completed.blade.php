                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; overflow:hidden; border-radius:18px; background:#ffffff; border:1px solid #dbe3ee;">
                    <tr>
                        <td style="padding:34px 38px; background:linear-gradient(135deg,#020617 0%,#0f172a 52%,#052e23 100%);">
                            ...
                            <h1 style="margin:0; color:#ffffff; font-size:28px; line-height:1.25; font-weight:800;">Onboarding submitted</h1>
                            <p style="margin:12px 0 0; color:#cbd5e1; font-size:15px; line-height:1.7;">An employee profile is ready for HR review.</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:38px;">
                            <h2 style="margin:0 0 14px; color:#0f172a; font-size:22px; line-height:1.35; font-weight:800;">Hello,</h2>
                            <p style="margin:0; color:#475569; font-size:16px; line-height:1.7;"><strong style="color:#0f172a;">{{ $displayName }}</strong> ({{ $employee->employee_id }}) has submitted their onboarding form.</p>
                            <p style="margin:18px 0 0; color:#475569; font-size:16px; line-height:1.7;">Review the details, then create their PHREMS login when everything looks correct.</p>

                            <table role="presentation" cellspacing="0" cellpadding="0" style="margin:30px 0;">
                                <tr>
                                    <td style="border-radius:12px; background:#157a52;">
                                        <a href="{{ $url }}" style="display:inline-block; padding:14px 24px; color:#ffffff; font-size:15px; font-weight:700; text-decoration:none; border-radius:12px;">Review Employee</a>
                                    </td>
                                </tr>
                            </table>
