...
<head>
    ...
    <title>Your pay slip is ready</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; overflow:hidden; border-radius:18px; background:#ffffff; border:1px solid #dbe3ee;">
                    <tr>
                        <td style="padding:34px 38px; background:#0f172a; border-bottom:4px solid #157a52;">
                            <p style="margin:0 0 12px; color:#a7f3d0; font-size:12px; font-weight:700; letter-spacing:3px; text-transform:uppercase;">PHREMS Pay Slip</p>
                            <h1 style="margin:0; color:#ffffff; font-size:28px; line-height:1.25; font-weight:800;">Your pay slip is ready</h1>
                            <p style="margin:12px 0 0; color:#cbd5e1; font-size:15px; line-height:1.7;">{{ $payment->monthLabel() }}</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:38px;">
                            ...
                            <p style="margin:0 0 24px; color:#475569; font-size:16px; line-height:1.7;">
                                Your pay slip for <strong>{{ $payment->monthLabel() }}</strong> is in PHREMS. Sign in to see the
                                details and download it as a PDF.
                            </p>

                            <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 0 28px;">
                                <tr>
                                    <td style="border-radius:12px; background:#157a52;">
                                        <a href="{{ $url }}" style="display:inline-block; padding:14px 26px; color:#ffffff; font-size:15px; font-weight:700; text-decoration:none; border-radius:12px;">View My Pay Slip</a>
                                    </td>
                                </tr>
                            </table>

                            <p style="margin:0 0 24px; color:#475569; font-size:14px; line-height:1.7;">
                                If anything on it looks wrong, contact HR within three working days.
                            </p>
