...
<head>
    ...
    <title>Complete your CreatiVision HRIS profile</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; overflow:hidden; border-radius:18px; background:#ffffff; border:1px solid #dbe3ee;">
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#020617;">
                                <tr>
                                    <td style="padding:34px 38px; background:linear-gradient(135deg,#020617 0%,#0f172a 52%,#052e23 100%);">
                                        ...
                                        <h1 style="margin:0; color:#ffffff; font-size:28px; line-height:1.25; font-weight:800;">Welcome to CreatiVision</h1>
                                        <p style="margin:12px 0 0; color:#cbd5e1; font-size:15px; line-height:1.7;">Your employee profile is ready for completion.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:38px;">
                            ...
                            <p style="margin:0; color:#475569; font-size:16px; line-height:1.7;">HR has set up your employee profile. Please complete it by providing your personal details so your HR record can be finalized.</p>

                            <table role="presentation" cellspacing="0" cellpadding="0" style="margin:30px 0;">
                                <tr>
                                    <td style="border-radius:12px; background:#157a52;">
                                        <a href="{{ $url }}" style="display:inline-block; padding:14px 24px; color:#ffffff; font-size:15px; font-weight:700; text-decoration:none; border-radius:12px;">Complete My Profile</a>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 28px; border-radius:14px; background:#f8fafc; border:1px solid #e2e8f0;">
                                <tr>
                                    <td style="padding:18px 20px;">
                                        <p style="margin:0; color:#334155; font-size:14px; line-height:1.6;"><strong>Security note:</strong> This link is unique to you and will expire after 7 days.</p>
                                    </td>
                                </tr>
                            </table>
